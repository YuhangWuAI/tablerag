...
# 使用示例
input_file = '/home/yuhangwu/Desktop/Projects/tablerag/data/processed/clarified_data/e2ewtq.jsonl'   # 输入的jsonl文件名
output_file = '/home/yuhangwu/Desktop/Projects/tablerag/data/processed/packed_data/packed_e2ewtq.jsonl' # 输出的jsonl文件名
