...
# 调用处理函数
input_file = '/home/yuhangwu/Desktop/Projects/tablerag/data/raw/small_dataset/e2etwq.jsonl'  # 替换为你的输入文件路径
output_file = '/home/yuhangwu/Desktop/Projects/tablerag/data/processed/clarified_data/e2ewq.jsonl'  # 替换为你的输出文件路径
